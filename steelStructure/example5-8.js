...
function example(
    ...
    x = 190, // 전단블록 x축 길이 (블록전단을 구하기 위해 필요)
    y = 40, // 전단블록 y축 길이 (블록전단을 구하기 위해 필요)

    x1 = 25.4, // 도심1 ㄱ, L 형강에서만 필요, 도심은 직접 구하자.
    x2 = 24.6, // 도심2 ㄱ, L 형강에서만 필요, 도심은 직접 구하자.
    l = 140, // 파스너 전체 간격, L 형강에서만 필요. 도심과 이걸 이용해야 전단지연계수를 구할 수 있다.
